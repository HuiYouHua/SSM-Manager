...
<body class="hold-transition skin-purple sidebar-mini">
                        ...
                        <ul class="pagination">
							...
							<c:if test="${pageInfo.pages>6}">
								...
								<c:if test="${pageInfo.pageNum>3 && pageInfo.pages-pageInfo.pageNum>3}">
									<c:forEach begin="${pageInfo.pageNum-3}" end="${pageInfo.pageNum+3}" var="pageNum">

										<c:if test="${pageInfo.pageNum==pageNum}">
											<li><a style="color: #23527c; background-color: #eee" href="${pageContext.request.contextPath}/orders/findAll.do?page=${pageNum}&size=${pageInfo.pageSize}">${pageNum}</a></li>
										</c:if>
										<c:if test="${pageInfo.pageNum!=pageNum}">
								...
								<c:if test="${pageInfo.pages-pageInfo.pageNum<=3}">
									<c:forEach begin="${pageInfo.pages-6}" end="${pageInfo.pages}" var="pageNum">
	...
	<script>
		function changePageSize() {
			...
			$("#changePageSize option[value="+pageSize+"]").attr('selsected','selected');
			//向服务器发送请求，改变没页显示条数
